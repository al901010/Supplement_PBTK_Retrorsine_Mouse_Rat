...
#assign(paste("out_MCMC",Condition,sep="_"), out_MCMC)
...
#assign(paste("MC",Condition,sep="_"), MC)
...
plot2 <-
  ...
  scale_color_manual(values = c("#3b738f","#3b738f","#3b738f","#68abb8","#68abb8","#68abb8",
                                "#813753","#813753","#813753","#c1766f","#c1766f","#c1766f"))+
  ...
  annotate("text", x = Inf-1, y = Inf-1, label = "Mouse  ",size=12, hjust=1.1, vjust=1.3)+
  annotation_logticks(sides="l",short = unit(2.5,"mm"),mid = unit(5,"mm"))


plot2
ggsave("plot2_mouse.png", bg="white", width = 9, height = 9)
